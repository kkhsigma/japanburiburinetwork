  ...
  return (
    <section className="relative overflow-hidden px-6 pt-28 pb-20 flex flex-col items-center text-center">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, #020810 0%, #041210 40%, #020810 100%)",
        }}
      />
      <ParticleBg />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 max-w-3xl">
        ...
        >
          <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-emerald-500/70 mb-4">
            Intelligence System
          </p>
          <h1
        ...
        >
          Regulatory monitoring, compound research, and market insights.
        </motion.p>
